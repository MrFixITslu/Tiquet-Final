...
export function InvoiceView({ job, settings, onClose }: InvoiceViewProps) {
    ...
    return (
        <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-md flex items-center justify-center z-[70] p-2 sm:p-4 overflow-y-auto">
            <div className="bg-white w-full max-w-3xl my-4 sm:my-8 rounded-none shadow-2xl p-6 sm:p-12 relative print:p-0 print:shadow-none print:my-0">
                <button
                    onClick={onClose}
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start gap-6 mb-8 sm:mb-12">
                    <div>
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold text-slate-900">{settings.name}</h2>
                    ...
                    <div className="text-left sm:text-right">
                        <h1 className="text-3xl sm:text-4xl font-light text-slate-300 uppercase tracking-widest mb-4">
                            Invoice
                        </h1>
